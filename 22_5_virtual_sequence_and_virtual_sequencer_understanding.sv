//////////////////////////////////////////////////////////////////////
  Concept of Virtual Sequence and Virtual Sequencer Understanding
//////////////////////////////////////////////////////////////////////
-First of all , as the name says virtual sequencer , means its not a real sequencer .Its not attached to any driver .
-When there is a need of stimulus co-ordination required among multiple sequencers , at that time the virtual sequencer comes in to picture.
-Virtual sequencer controls other sequencers and it is not attached to any driver.
-Similarly , A virtual sequence is nothing but a container that starts multiple sequences on different sequencers.
...
-So, we usually keep separate agents to handle the different protocols
-Hence , we need to execute sequences on corresponding sequencers present in each agent.
-At that time , for the better co-ordination among each sequenceers , virtual sequencer play an important role.  
...
-Similarly , virtual sequence is nothing but a container that starts multiple sequences.virtual sequence is usually executed on the virtual sequencer. 

//////////////////////////////////////////////////////////////////////////////////  
   Examples:
   To understand the concept of Virtual Sequence and Virtual Sequencer in depth, 
   we have here Four variety of examples as below .
///////////////////////////////////////////////////////////////////////////////////  
