...
/////////////////////////////////////  
-In a type override, a substitute component class type is created instead of an original component class in the testbench hierarchy. 
-This applies to all instances of that component type.
-Methods of type override in UVM factory are:
...
-Methods of instance override in UVM factory are:
...
-NOTE : To understand the above concepts , Please go through the below examples.
-It is used with both uvm_object and uvm_component as well. (Examples were committed with this repo using name 10_*)
