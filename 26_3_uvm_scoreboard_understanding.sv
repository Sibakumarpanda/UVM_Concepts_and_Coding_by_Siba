...
-The reference model is also known as a predictor that implements design behavior 
-Hence ,scoreboard can compare DUT outcome with reference model outcome for the same driven stimulus.  
...
-Since the scoreboard is a uvm_component. The new() function has two arguments as string name and uvm_component parent.
