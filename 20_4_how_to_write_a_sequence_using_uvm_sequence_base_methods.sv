...
function                    create_item                                                                        This creates and initializes request items or sequences 
                                                                                                               and initializes using the factory.
  
task                        wait_for_grant                                                                     This task issues a request to the current sequencer 
                                                                                                               and it returns when the sequencer has granted the sequence. 
                                                                                                               Hence, it is a blocking method that waits for a grant from the sequencer.
  
function                    send_request(uvm_sequence_item request, bit rerandomize = 0)                      Send request items to the driver via the sequencer. 
                                                                                                              If rerandomize = 1, the item will be randomized before 
                                                                                                              sent to the driver. 

task                        wait_for_item_done()                                                              This task will block until the driver calls put or item_done. 
                                                                                                              It is an optional call.
