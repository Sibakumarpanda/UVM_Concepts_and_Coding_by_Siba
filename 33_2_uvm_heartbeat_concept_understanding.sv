...
-The lock-up may happen due to vrious issues like :
   FSM issues
   race around conditions between two communicating modules waiting for the response 
   for transmitted packet or packet is not being transmitted, etc.  

///////////////////////////////     
  UVM Heartbeat Working 
///////////////////////////////     
-The uvm_heartbeat monitor activity for an objection object. 
-The UVM Heartbeat detects testbench activity for registered components based on raises or drops objections on that objection object 
 during the heartbeat monitor window. 
...
new                 function new (string name,                          The uvm_heartbeat constructor creates a new heartbeat instance 
                                                                        associated with cntxt.
                                 ...
                                 uvm_objection objection = null )       cntxt: Specifies context where heartbeat objections will be monitored. 
                                                                        ...
                                                                        It is optional. It can be null but it must be set 
                                                                        before activation of the heartbeat monitor.  
