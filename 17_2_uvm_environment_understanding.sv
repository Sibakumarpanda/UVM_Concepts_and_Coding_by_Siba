...
////////////////////////////////////////
-An environment provides a well-mannered hierarchy and container for agents, scoreboard and other verification components like functional coverage block.
...
class my_env extends uvm_env;
  ...
  function void connect_phase(uvm_phase phase);
    ...
    // Example:  agt.mon.item_collect_port.connect(sb.item_collect_export);
  endfunction
