...
////////////////////////////////////////////////////////////////  
 1. Although both classes provide a convenience layer on top of the uvm resource facility, uvm_config_db is derived from uvm_resource_db. 
    This adds up additional methods on top of uvm_resource_db methods.
 2. With respect to component hierarchy, the uvm_config_db  has an argument as :
       context that has the type of uvm_component and 
       string instance name that provides more flexibility as compared to uvm_resource that has two strings scope and name. 
       string field name
